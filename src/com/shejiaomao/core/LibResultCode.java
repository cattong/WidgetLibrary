...
public final class LibResultCode {
	...
	public static final int NET_HTTPS_UNDER_CMWAP          = 1111;      //wap下无法使用https,建议切换成net网络
	...
	public static final int API_PARAM_ERROR           = 40001;    //参数错误，请参考API文档;
	...
	public static final int API_RATE_LIMITED           = 40312;    //API调用次数超限，请稍候重试或联系管理员
	public static final int API_RATE_INVOKE_TOO_QUICK  = 40401;    //发表太快，被频率限制
	public static final int API_RATE_SEARCH_LIMITED    = 40402;    //搜索调用次数超限，请稍候重试
	...
	public static final int API_USER_UID_EMPTY         = 40041;    //uid参数为空;
	...
	public static final int API_TWEET_CONTENT_EMPTY          = 40012;    //内容为空;
	public static final int API_TWEET_CONTENT_OVER_LENGTH    = 40013;    //微博内容过长，请确认不超过140个字符;
	public static final int API_TWEET_CONTENT_ILLEGAL        = 40076;    //含有非法词,比如脏话过多，包含垃圾信息、广告信息等;
	...
	public static final int API_TWEET_RETWEET_SELF     = 40034;    //不能转发自己的微博;

	public static final int API_TWEET_IMAGE_UPLOAD_ERROR     = 40009;    //图片错误，请确保使用multipart上传了图片;
	public static final int API_TWEET_IMAGE_FORMAT_UNSUPPORT = 40045;    //不支持的图片类型,支持的图片类型有JPG,GIF,PNG;
	public static final int API_TWEET_IMAGE_OVER_SIZE        = 40008;    //上传的图片过大，图片大小上限为5M;

	public static final int API_MESSAGE_NOT_EXIST      = 40010;    //私信不存在;
	public static final int API_MESSAGE_LIMITED        = 40011;    //私信发布超过上限;
	public static final int API_MESSAGE_NOT_FOLLOWER   = 40017;    //不能给未关注您的人发私信;UNFOLLOW YOU
	...
	public static final int API_RELATIONSHIP_HAS_FOLLOWED      = 40303;    //已关注此用户;
	public static final int API_RELATIONSHIP_IDS_EMPTY         = 40018;    //Ids参数为空;
	public static final int API_RELATIONSHIP_IDS_TOO_MANY      = 40024;    //ids过多，请参考API文档;
	public static final int API_RELATIONSHIP_OVER              = 40304;    //关系操作超过上限;
	...
	public static final int API_LIST_PRIVATE_UNSUPPORT    = 40073;    //目前不支持私有分组;
	public static final int API_LIST_PRIVATE_SUPPORT_ONLY = 40084;    //目前只支持私有分组 ;
	...
	public static final int API_PERMISSION_INSUFFICIENT    = 40053;    //权限不足，只有创建者有相关权限;
