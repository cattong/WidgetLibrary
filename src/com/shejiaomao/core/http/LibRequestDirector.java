...
class LibRequestDirector implements RequestDirector {
        ...
        try {
            ...
            while (!done) {
                ...
                if (managedConn == null) {
	                ...
	                if (HttpConnectionParams.isStaleCheckingEnabled(params)) {
	                    ...
	                    if (managedConn.isOpen()) {	                        
	                    	if (LibConstants.isDebug()) logger.trace("Stale connection check");
                ...
                try {
                	...
                	if (LibConstants.isDebug()) logger.trace(ex.getMessage(), ex);
    ...
    protected RoutedRequest handleResponse(RoutedRequest roureq,
        ...
        if (HttpClientParams.isRedirecting(params) &&
            ...
            if (LibConstants.level <= LibConstants.VERBOSE) logger.trace("Redirecting to '{}' via {}", uri, newRoute);
