...
public abstract class PhotoViewGestureDetector {
	static final String LOG_TAG = "VersionedGestureDetector";
	OnGestureListener mListener;

	public static PhotoViewGestureDetector newInstance(Context context, OnGestureListener listener) {
		final int sdkVersion = Build.VERSION.SDK_INT;
		PhotoViewGestureDetector detector = null;
	...
	private static class CupcakeDetector extends PhotoViewGestureDetector {
